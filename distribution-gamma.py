...
for i in range(X_RANGE): 
    ...
    if (i < 100) or (i == X_RANGE - 1):
        ...
        ax5.cla()
        ax6.cla()
        ax4.hist(distr_1_k, bins = bins_1, density=True, rwidth=0.8, alpha=0.4, color='r', label=f'sample {Y_RANGE} {P1}')
        ax5.hist(distr_2_k, bins = bins_2, density=True, rwidth=0.8, alpha=0.4, color='g', label=f'sample {Y_RANGE} {P2}')
        ax6.hist(distr_3_k, bins = bins_3, density=True, rwidth=0.8, alpha=0.4, color='b', label=f'sample {Y_RANGE} {P3}')
